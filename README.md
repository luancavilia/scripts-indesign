# Scripts para Adobe InDesign

Automações e utilitários para diagramação no InDesign.

## Instalação
1. Baixe os arquivos `.jsx`.
2. Abra o painel de scripts no InDesign (`Window > Utilities > Scripts`).
3. Clique com o botão direito na pasta "User" e escolha "Reveal in Explorer/Finder".
